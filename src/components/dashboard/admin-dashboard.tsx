      ...
      <div className="flex min-h-screen w-full flex-col lg:flex-row">
          ...
          <nav className="grid gap-1 overflow-y-auto p-2 text-sm font-bold text-slate-700 sm:p-3" aria-label="Secciones del panel">
            ...
            {canManageCatalogs ? (
              <SidebarItem
                ...
                href="/dashboard?view=work-order-plans"
                collapsed={isSidebarCollapsed}
              />
            ) : null}
            {canManageCatalogs ? (
        ...
        <main id="summary" className="min-w-0 flex-1">
          ...
          <div className="grid gap-5 px-3 py-4 sm:px-4 lg:px-6 lg:py-5">
            ...
            {activeSection === "work-order-plans" && canManageCatalogs ? (
              <div id="work-order-plans" className="scroll-mt-24">
                <EntityManager kind="work-order-plans" />
              </div>
            ) : null}
            ...
            {activeSection === "inventory" && canManageCatalogs ? (
              <div id="inventory" className="scroll-mt-24">
                <EntityManager kind="inventory" />
              </div>
            ) : null}
