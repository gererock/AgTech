  ...
  return (
    <div className="space-y-6">
      ...
      {isFormOpen ? createPortal(
        <div className="fixed inset-0 z-[99999] flex items-start sm:items-center justify-center overflow-y-auto bg-slate-950/60 p-4 pt-6 sm:pt-0" onClick={() => { resetForm(); setIsFormOpen(false); }}>
          <div className="w-full max-w-[min(92vw,48rem)] max-h-[90vh] sm:max-h-[calc(100vh-4rem)] overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.20)]" onClick={(event) => event.stopPropagation()}>
